...
class AtividadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atividade" do
    assert_difference('Atividade.count') do
      post atividades_url, params: { atividade: { description: @atividade.description, name: @atividade.name, turma_id: @atividade.turma_id, user_id: @atividade.user_id } }, as: :json
    end
  ...
  test "should update atividade" do
    patch atividade_url(@atividade), params: { atividade: { description: @atividade.description, name: @atividade.name, turma_id: @atividade.turma_id, user_id: @atividade.user_id } }, as: :json
    assert_response 200
  end
